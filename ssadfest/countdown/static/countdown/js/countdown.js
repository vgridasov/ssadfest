...
function CDT(){
 ...
 // Set countdown limit
 var tl = new Date('2018/07/27 20:00:00');

 // You can add time's up message here
 var timer = new CountdownTimer('CDT',tl,'<span class="number-wrapper"><div class="line"></div><span class="number end">С ДНЕМ СИСАДМИНА!!!</span></span>');
 timer.countDown();
}
